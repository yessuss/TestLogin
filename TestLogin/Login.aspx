<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="TestLogin.Login" %>
            ...
            <form id="formulario_login" runat="server"> 
                <div class="form-control">
                    ...
                    <div class="row">
                        ...
                        <asp:Button ID="BtnRegistro" CssClass="btn btn-link" runat="server" Text="¿No tienes cuenta? Registrate" OnClick="BtnRegistrar_Click" />
                    </div>
                </div>
            </form>
        </div>
